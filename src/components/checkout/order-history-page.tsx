...
import { ArrowLeft, BookOpen, CheckCircle2, Package, ShoppingCart } from "lucide-react";
              ...
              <div key={o.id} className="rounded-2xl border border-border bg-card p-4">
                <div className="flex flex-wrap items-start justify-between gap-3">
                  ...
                  <div className="text-right">
                    ...
                    <span className={cn("mt-1 inline-block rounded-full px-2 py-0.5 text-[10px] font-bold uppercase", statusBadge(o.status))}>{o.status}</span>
                  </div>
                </div>
                <div className="mt-3 flex flex-wrap items-center gap-4 border-t border-border pt-3 text-xs text-muted-foreground">
                  ...
                  {o.isEnrolled && (
                    <Link href="/courses" className="ml-auto inline-flex items-center gap-1 font-semibold text-primary hover:underline">
