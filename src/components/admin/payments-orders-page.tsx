  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div>
          <h1 className="text-2xl font-extrabold text-ink">Payments & Orders</h1>
          <p className="mt-1 text-sm text-muted-foreground">Track revenue, transactions & course purchases</p>
        </div>
      ...
      <div className="flex gap-2 border-b border-border">
        <button
          ...
          className={cn(
            "inline-flex items-center gap-2 border-b-2 px-4 py-2 text-sm font-semibold",
      ...
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
        ...
        {tab === "payments" ? (
          <>
            <select value={payMethod} onChange={(e) => setPayMethod(e.target.value)} className={selectClass}>
